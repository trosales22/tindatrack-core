...
export const updateMyProfile = (payload: UpdateMyProfilePayload) =>
  axios.put('/api/v1/core/my_profile', payload);

export const changePassword = (payload: ChangePaswordPayload) =>
  axios.put('/api/v1/core/change_password', payload);

export const registerBusinessAdmin = (payload: RegisterBusinessAdminPayload) =>
  axios.post('/api/v1/core/business_admin/register', payload);
