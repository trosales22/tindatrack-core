...
import {
  useShowBusinessSalesByIdQuery,
  useUpdateBusinessSalesMutation,
} from 'hooks/business-sales';
...
const EditBusinessSalesForm: FC<EditBusinessSalesFormProps> = ({
  businessId,
  salesId,
  onClose,
}) => {
  ...
  const { mutate: updateBusinessSales, isPending: isUpdateBusinessSalesLoading } =
    useUpdateBusinessSalesMutation({
      onSuccess: () => {
        addToast({
