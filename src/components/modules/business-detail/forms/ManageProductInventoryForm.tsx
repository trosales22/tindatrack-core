...
import {
  useManageProductInventoryMutation,
...
const ManageProductInventoryForm: React.FC<ManageProductInventoryFormProps> = ({
  businessId,
  productId,
  onClose,
}) => {
  ...
  const { mutate: manageProductInventory, isPending: isManageProductInventoryLoading } =
    useManageProductInventoryMutation({
      onSuccess: (res) => {
        addToast({
    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" disabled={isManageProductInventoryLoading}>
            {isManageProductInventoryLoading ? 'Saving..' : 'Save Changes'}
          </Button>
        </div>
      </form>
    </>
