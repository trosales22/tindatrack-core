      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center mb-4">
        ...
        <div className="flex sm:justify-end">
          <Button
            variant="primary"
            className="px-4 py-2"
            onClick={() => setOpenCreateBusinessSales(true)}
          >
            + Add Sales
          </Button>
        </div>
              ...
              return (
                <tr key={item.id}>
                  ...
                  <td className="font-medium">
                    ...
                    <b>({item?.attributes?.product?.category?.label})</b>
                  </td>
                  <td className="font-medium">
                    {formatCurrency(item?.attributes?.cost_price || 0)}
                  </td>
                  <td className="font-medium">{item?.attributes?.quantity || 0}</td>
                  <td className="font-medium">
                    {formatCurrency(item?.attributes?.total_amount || 0)}
                  </td>
